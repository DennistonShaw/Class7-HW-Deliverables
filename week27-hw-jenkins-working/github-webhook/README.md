...
![new git trigger](./Screenshots/new-git-trigger.png)
---

# Logans file: https://github.com/LD2343/Jenkins_Pipeline_Trigger_Lab/blob/main/armageddon_evidence_files/Armageddon_Group_Link.txt
